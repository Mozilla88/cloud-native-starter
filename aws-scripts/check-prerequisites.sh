...
function checkPrerequisites() {
    ...
    eksctl version &> /dev/null|| MISSING_TOOLS="${MISSING_TOOLS} eksctl CLI"
    if [[ -n "$MISSING_TOOLS" ]]; then
      ...
      _out Do you have an AWS Cloud account? Get one for free here: https://portal.aws.amazon.com/billing/signup#/start
    fi
}
